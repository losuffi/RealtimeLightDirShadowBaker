Shader "ArtStandard/Standard/Forward"
{
    Properties
    {
        ...
        _ShadowCubeMap("Shadow Cubemap", Cube) = "white"{}
        _RelativeDist("Relative Dist",float) = 100
        _CubePoint("Cubemap position",Vector) = (0,0,0,0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(Input i):SV_Target
            {
                ...
                atten = CalcAttenByShadowCube(_ShadowCubeMap, _RelativeDist, i.worldPos, _CubePoint.xyz,_WorldSpaceLightPos0.xyz);
